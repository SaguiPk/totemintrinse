...
class Url_Sheets:
    ...
    def celula(self, id:str):
        self.api_url = f'https://sheets.googleapis.com/v4/spreadsheets/1PBwyM79jZS7b4GxSr1ayocGleWT48k9V?gid={id}ranges=B15&fields=sheets/data/rowData/values/effectiveFormat/backgroundColor'
